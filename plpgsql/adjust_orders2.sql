...
BEGIN
    ...
    LOOP
        ...
        UPDATE valid_orders SET quantity_adjusted = valid_order.quantity WHERE id = valid_order.id;
    END LOOP;
    ...
    LOOP
        IF NOT valid_order.quantity_adjusted_locked THEN
            ...
            UPDATE valid_orders SET quantity_adjusted = adjusted_quantity WHERE id = valid_order.id;
        END IF;
    END LOOP;
    ...
    IF remaining_difference <> 0 THEN
        ...
        FOR i IN 0..steps - 1 LOOP
            ...
            LOOP
                IF NOT valid_order.quantity_adjusted_locked THEN
                    UPDATE valid_orders SET quantity_adjusted = quantity_adjusted + step WHERE id = valid_order.id;
                END IF;
            END LOOP;
        END LOOP;
